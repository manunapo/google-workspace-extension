...
export const GETSTYLED_API_KEY = 'GETSTYLED_API_KEY';
export const DEFAULT_FREE_CREDITS = 25;
export const DEFAULT_REVIEW_CREDITS = 35;

// Pricing Plans
export const ESSENTIAL_CREDITS = 150;
export const ESSENTIAL_PRICE = '$5.90';
export const PRO_CREDITS = 500;
export const PRO_PRICE = '$9.90/month';
